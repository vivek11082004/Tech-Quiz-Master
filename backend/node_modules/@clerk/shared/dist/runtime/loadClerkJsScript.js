...
const require_versionSelector = require('./versionSelector-DQPvR1Ks.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	return `https://${buildScriptHost({
		...
		proxyUrl,
		domain
	})}/npm/@clerk/ui@${require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.5.0")}/dist/ui.browser.js`;
};
